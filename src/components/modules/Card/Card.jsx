...
function Card({img , title , onlineLink , id}) {
  return (
    ...
    <div className="block mt-4">
        ...
        <div className="flex items-center gap-8 mt-8">
            <Link href={`/SampleWork/${id}`}className='flex items-center justify-center bg-back w-[130px] h-12 text-white rounded-lg duration-300 ease-out hover:bg-font-default hover:text-back '>مشاهده جزئیات بیشتر</Link>
